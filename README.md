...
| `/v3/` | **v3**（[v3/README.md](v3/README.md)） — **LP 本番候補** | standalone 単一 HTML | LP standalone bundle |
| `/v4/` | **v4**（[v4/README.md](v4/README.md)） — **UTUTU 本番候補** | standalone 単一 HTML | UTUTU standalone bundle |

→ v0/v1/v2 は JSX + Babel CDN のプロトタイプ。v3/v4 は外部依存ゼロの自己完結 HTML で、本番候補。
