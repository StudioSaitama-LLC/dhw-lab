...
| `/v6/` | **v6**（[v6/README.md](v6/README.md)） — **公開版（最新）** | standalone 単一 HTML | 2026-06-08 受領の新ビルド (Claude Design 再ハンドオフ) |

→ v0/v1/v2 は JSX + Babel CDN のプロトタイプ。v3/v4/v5/v6 は外部依存ゼロの自己完結 HTML。
...
- **v6: https://studiosaitama-llc.github.io/dhw-lab/v6/** ← 公開版（最新）
